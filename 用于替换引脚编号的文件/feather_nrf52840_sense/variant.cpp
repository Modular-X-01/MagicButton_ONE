...
const uint32_t g_ADigitalPinMap[] =
{
  ...
  18,      //D37 P0.18 is RESET (attached to switch)
  // 
  // The remaining pins are not connected (per schematic)
  33,      //D38 P1.01 is not connected per schematic
  35,      //D39 P1.03 is not connected per schematic
  ...
  44,      //D45 P1.12 is not connected per schematic
  45,      //D46 P1.13 is not connected per schematic
  46,      //D47 P1.14 is not connected per schematic
};
